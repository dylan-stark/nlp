...
Unfortunately, while the user benefits from lower prices and increased portability, they suffer from hunting and pecking with our thumbs over tiny keyboards, like animals, to produce even the simplest of text messages.
